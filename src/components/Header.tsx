...
//  import {logo} from '/public/logo.png'
 ...
 function Header(){
    return (
        <nav className="relative flex flex-wrap items-center justify-between px-2 py-3 bg-white mb-3  h-[70px]">
            <div className="w-[1145px] container px-4 mx-auto flex flex-wrap items-center justify-between mt-[5px]">
